...
//Removendo item através do indice do array com método splice(indice, qtd)
// let indice = frutas.indexOf("pêra");
...
// //Ao invés de concatenar os arrays vamos utilizar o operador SPREAD( ... ) para melhorar a inserção dos dados no novo array.
...
// //CONVERTER EM ARRAY 
// const imgElements = [...document.getElementsByTagName(".conteudo img")];
// //REMOVIVEL COM ...//const imgElementsArray = [...imgElements];
// //varios consts são removiveis também com .X
// imgElements.forEach( (img)=>{
//     img.setAttribute("style","width:20%;")
// });

//OUTLINES E EM CARACTERES INSUFICIENTES
...
//MOSTRAR SEHNA
//Exercício: toggle slash eye icon
